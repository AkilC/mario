...
public class Main {
    ...
    static void blocks(int height) {
        ...
        for(int row = 0;row<height; row++){
            ...
            //print spaces to split left and right side
            System.out.print("  ");
            //create right side of pyramid. On this part, the number of hashes on each row will equal whichever row it is on. Ex: Row 6(index 5) will output 6(index 5) hashes
